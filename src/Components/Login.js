...
const Login = () =>{
    return(
        <>
        <div className="text-center  image mt-3">
        ...
        <Container className="containers">
          <h4 style={{fontFamily:'poppins',fontWeight:'400'}}>Hello There!</h4>
          <p style={{fontFamily:'poppins',fontSize:'13px'}}>Enter your email and passward to sign in </p>
   ...
   <Form.Group className=" mb-3" controlId="exampleForm.ControlTextarea1">
      ...
      <FormGroup>
      <div className="text-center" style={{fontSize:'13px',paddingTop:'3%',paddingBottom:'1%',fontFamily:'poppins'}}>Already have an account?  <Link to='/'  ><button>Sign up</button></Link>
      <p style={{color:'grey'}}>Or continue with</p>
  <p>
  <Link to='https://support.google.com/accounts/answer/27441?hl=en'><img src={google} style={{width:'30px',height:'30px'}} alt="Google"/></Link> </p> </div>
  </FormGroup>
            </Container></>
    )
}
